...
const OfferCard: React.FC<OfferCardProps> = memo(
  ({ offer, viewMode, onAccept, onReject, onCounter, onWithdraw }) => {
    ...
    // Memoized wallet truncator
    const truncateWallet = useCallback(
      (wallet: string) => `${wallet.slice(0, 4)}...${wallet.slice(-4)}`,
      []
    );
      ...
      <div className={styles.offerCard}>
        <div className={styles.header}>
          ...
          <div
            ...
            style={{ backgroundColor: STATUS_COLORS[offer.status] }}
          >
